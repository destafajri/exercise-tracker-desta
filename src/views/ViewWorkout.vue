<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item, index) in data.exercises" :key="index">
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <input required id="exercise-name" v-if="edit" class="p-2 w-full text-gray-500 focus:outline-none" type="text" v-model="item.exercise"/>
              <p v-else>
                {{ item.exercise }}
              </p>
            </div>
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="sets" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.sets"/>
              <p v-else>
                {{ item.sets }}
              </p>
            </div>
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="reps" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.reps"/>
              <p v-else>
                {{ item.reps }}
              </p>
            </div>
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="weight" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.weight"/>
              <p v-else>
                {{ item.weight }}
              </p>
            </div>
          ...
          <button v-if="edit" @click="addExercise" type="button" class="py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
            Add Exercise
          </button>
        </div>
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          <div class="flex flex-col gap-x-6 gap-y-2 relative sm:flex-row" v-for="(item, index) in data.exercises" :key="index">
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <select required id="cardioType" v-if="edit" class="p-2 w-full text-gray-500 focus:outline-none" v-model="item.cardioType">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="distance" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.distance"/>
              <p v-else>
                {{ item.distance }}
              </p>
            </div>
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="duration" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.duration"/>
              <p v-else>
                {{ item.duration }}
              </p>
            </div>
            <div class="flex flex-1 flex-col">
              ...
              <input required v-if="edit" id="pace" class="p-2 w-full text-gray-500 focus:outline-none" type="number" v-model="item.pace"/>
              <p v-else>
                {{ item.pace }}
              </p>
            </div>
          ...
          <button @click="addExercise" v-if="edit" type="button" class="py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
            Add Exercise
          </button>
        </div>
      </div>
      ...
      <!-- Update -->
      <button v-if="edit" @click="update" type="button" class="mt-10 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">
        Update Workout
      </button>
    </div>
  </div>
